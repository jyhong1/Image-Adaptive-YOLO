...
parser.add_argument('--epoch_second_stage', dest='epoch_second_stage', type=int, default=40, help='# of epochs')
...
parser.add_argument('--WEIGHT_FILE', dest='WEIGHT_FILE', nargs='*', default='./experiments/exp_101/checkpoint/yolov3_test_loss=6.0854.ckpt-68', help='folder of the training data')
parser.add_argument('--pre_train', dest='pre_train', default='./experiments/exp_101/checkpoint/yolov3_test_loss=11.6394.ckpt-18', help='the path of pretrained models if is not null. not used for now')
...
cfg.filters = [
    DefogFilter, ExposureFilter, GammaFilter, ImprovedWhiteBalanceFilter,
    SaturationPlusFilter, ToneFilter, ContrastFilter, WNBFilter, ColorFilter, UsmFilter
]
cfg.num_filter_parameters = 42
...
#--- Add ---#
cfg.defog_begin_param = 0       # 1
cfg.exposure_begin_param = 1    # 1
cfg.gamma_begin_param = 2       # 1
cfg.wb_begin_param = 3          # self.channels = 3
cfg.saturation_begin_param = 6  # 1
cfg.tone_begin_param = 7        # cfg.curve_steps = 8
cfg.contrast_begin_param = 15   # 1
cfg.wnb_begin_param = 16        # 1
cfg.color_begin_param = 17      # self.channels * cfg.curve_steps = int(net.shape[3]) * 8 = 3 * 8 = 24
cfg.usm_begin_param = 41        # 1
